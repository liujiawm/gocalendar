...
func meanNewMoon(jd float64)(float64,float64){
	...
	// 2451550.09765为2000年1月6日14时20分36秒之JD值.
	kn := math.Floor((jd - 2451550.09765) / synMonth)

	jdt := 2451550.09765 + kn * synMonth
...
// 求出含某公历年立春点开始的24节气
func (d *Date)Jieqi()([24]JQ){

	jq := [24]JQ{}

	dj := adjustedJQ(d.Year - 1, 21, 23)
